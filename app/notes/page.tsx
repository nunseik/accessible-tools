  ...
  return (
    <div className="flex flex-col min-h-svh p-4 gap-4">
      <header className="flex items-center gap-3 pt-2">
        ...
        <Link href="/notes/new" aria-label={t("newAria")}
            ...
            <div key={note.id}
              ...
              <div className="flex items-start justify-between gap-2">
                ...
                <button
                  ...
                  aria-label={deleting === note.id ? t("confirmDelete") : t("deleteAria")}
              ...
              <TTSButton text={`${note.title}. ${note.content}`} label={t("readNote")} />
            </div>
          ))}
        </div>
      )}
